...
makeImagePath.Value = "D:/FEKO/SoftWare/F22/straight_overhead_02_feko_new"
form:Add(pf.FormLabel.New("View Angle Index:"), 2, 1)
form:Add(viewAngle, 2, 2)
viewAngle.Value = "67"
form:Add(pf.FormLabel.New("Angle Range Index:"), 3, 1)
...
for file in lfs.dir(imagePath) do
    if file ~= "." and file ~= ".." then  
        ...
        if file_exists(dirnames[1]..string.format("_%s.png",dirnames[2])) then
            inspect(dirnames)
