...
print("load before fft file !")
local mfile = assert(io.open( "D:/FEKO/beforeFFT/record_rot_02_output_image/F22_1_beforeFFT_gaussian-15.txt", "r" ), "Could not create the file for writing. Ensure that you have write access.")
...
for f=1,freqSamples do
    for a=1,angSamples do
       temp_c = string.split(mat_list[index]," ")
