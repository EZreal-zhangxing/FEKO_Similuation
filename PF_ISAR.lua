...
print(string.format("view angle index ang0sel.index is %d",ang0sel.Index))
print(string.format("view angle value ang0sel.Value is %s",ang0sel.Value))
--Viewing Range
...
assert(rForm:Run(), "Cancelled")
print(string.format("angle range index angrsel.index is %d",angrsel.Index))
print(string.format("angle range value angrsel.Value is %s",angrsel.Value))
--Get Data from forms
...
-- print(string.format("ang0sel.Value is %d",ang0sel.Value))
