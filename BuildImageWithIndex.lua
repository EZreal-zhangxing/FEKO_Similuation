...
angrsel_Index = angleValue
angleValue_Value = 0
for k,v in ipairs(lRanges) do
    if k == angleValue then
        angleValue_Value = v
        break
    end
end
...
print(string.format("ang0sel_value is %f angrsel_value: %f",viewAngle_Value,angleValue_Value))
...
--Viewing Range
ang0 = viewAngle_Value -- Viewing angle value
